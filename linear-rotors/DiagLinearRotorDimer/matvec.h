...
//	friend vector operator*(const symmatrix& arg1, const vector& arg2);
	friend  vector  operator*(const diagmat& arg1, const vector& arg2);
...
public:
	...
	friend  complex operator*(const cvector& arg1, const cvector& arg2);
...
//	friend cvector operator*(const hermmatrix& arg1, const cvector& arg2);
	friend  cvector operator*(const cdiagmat& arg1, const cvector& arg2);
...
/* operations to code (friends) */
	...
	friend  matrix transpose(const matrix& arg1);
	friend vector compdiag(const matrix& PRe,const matrix& PIm);
	friend vector hermdiag(matrix& PRe,matrix& PIm);
	friend vector diag(matrix& a);
	friend vector Hpsifort(matrix &TR,matrix &Ttheta1,matrix &Ttheta2,
	...
	friend matrix ql(vector &D,vector &E);
	friend vector diaggen(matrix& a);
	friend  matrix  operator*(const matrix&, const diagmat&);
	friend  matrix  operator*(const diagmat&, const matrix&);
...
/* operations to code (friends) */
	friend  cmatrix  operator*(const cmatrix&, const cdiagmat&);
	friend  cmatrix  operator*(const cdiagmat&, const cmatrix&);
...
/* operations to code (friends) */
	...
	friend  cmatrix operator*(const cmatrix&, const cmatrix&);
	friend  cvector operator*(const cmatrix&, const cvector&); 
	friend  cmatrix operator*(const complex arg1, const cmatrix& arg2);
...
*,int *);
EXTERN void dptgemm_(char *transa,char *transb,int *m,int *n,
...
EXTERN void  FORTRAN(wangpot)(double *V,double *r,double *c);
EXTERN void  FORTRAN(wanghehe)(double *Vhehe,double *rhe);
EXTERN void  FORTRAN(co2h2pes)(double *dphi,double *dth2,double *dth1,double *RR,double *Vtot,int *iv3);
EXTERN void  FORTRAN(poth2h2)(double *R,double *th1,double *th2,double *phi,double *Eint);
