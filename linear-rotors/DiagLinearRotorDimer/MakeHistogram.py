...
nbins       = 50          #change
srcfile     = "/work/tapas/linear_rotors/Rpt10.0Angstrom-DipoleMoment1.86Debye-tau0.002Kinv-Blocks10000-System2HF-e0vsbeads11/results/pigs_instant.dof"
srcfile1     = "/work/tapas/linear_rotors/Rpt10.0Angstrom-DipoleMoment1.86Debye-tau0.002Kinv-Blocks5000-System2HF-e0vsbeads5/results/pigs_instant.dof"
#srcfile_exact = "Results-Jrot5-Rpt7.0Angstrom/DataForHistogramFor2HF-DipoleMoment1.86Debye.txt"
col_costheta = loadtxt(srcfile, unpack=True, usecols=[2])
