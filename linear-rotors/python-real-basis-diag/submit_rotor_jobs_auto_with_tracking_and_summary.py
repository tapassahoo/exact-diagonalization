...
# CONFIGURATION
# -----------------------------
potential_strength_list = [0.1, 0.5, 1.0, 2.0]
max_angular_momentum_list = [10, 20, 30, 40, 50]
spin_type = "spinless"  # Choose from: "spinless", "ortho", "para"
script_name = "monomer_rotor_real_basis_diagonalization.py"
base_output_dir = f"HF_monomer_in_field_spin_{spin_type}"
...
for v0, jmax in product(potential_strength_list, max_angular_momentum_list):
	tag = f"V{v0:.2f}_J{jmax:02d}_{spin_type}"
